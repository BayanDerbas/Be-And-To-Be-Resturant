...
class _CouponService implements CouponService {
  _CouponService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  @override
  Future<CouponModel> getAllCoupon({required int branch_id}) async {
    ...
    final _options = _setStreamType<CouponModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'http://127.0.0.1:8000/api/show_coupons/${branch_id}',
