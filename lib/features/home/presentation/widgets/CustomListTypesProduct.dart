...
import '../../../order/presentation/pages/order_with_meal_id.dart';
                ...
                onTap: () {
                  showDialog(
                    ...
                    builder: (_) => Dialog(
                      ...
                      child: OrderWithMealId(mealId: (type['id'] as int)),
                    ),
                  );
                },
              ),
...
//                       backgroundColor: Colors.transparent,
//                       child: Order(
//                         meal: type, // هنا مررت النوع الفعلي
//                       ),
//                     ),
//                   );
//                 },
